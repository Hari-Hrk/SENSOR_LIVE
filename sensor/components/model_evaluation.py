...
from sensor.utils.main_utils import load_numpy_array_data,write_yaml_file,load_object
...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            y_latested_pred = latest_model.predict(df)
            trained_metric = get_classification_score(y_true,y_trained_pred)
            latest_metric = get_classification_score(y_true,y_latested_pred)
